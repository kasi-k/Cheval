...
const GoodsBills = () => {
  ...
  const options = [
    { label: "Generate", value: "generate", path: "generate_goodsbills" },
    { label: "View", value: "view", path: "view_goodsbills" },
    { label: "Download", value: "download", path: "download_goodsbills" },
  ];
