    ...
    <>
      ...
      <div className="font-roboto-flex mx-2 grid lg:grid-cols-12 md:grid-cols-8  gap-4 dark:text-white my-6">
        <div className="col-span-3 p-6 space-y-4 dark:bg-darkgray bg-white   rounded-2xl">
          ...
          <div className="grid grid-cols-5 gap-2 font-light text-xs">
        ...
        <div className="col-span-3 p-6 space-y-4 row-span-2 dark:bg-darkgray bg-white   rounded-2xl">
        ...
        <div className="col-span-3 p-6 space-y-4 dark:bg-darkgray bg-white row-span-2  rounded-2xl">
        ...
        <div className="col-span-3 p-6 space-y-4 dark:bg-darkgray bg-white row-span-2  rounded-2xl">
          ...
          <div className="grid grid-cols-3 gap-2 font-light text-xs">
            <p className="col-span-2">Vehicle Type</p>
            <p className="col-span-1">Truck</p>
            <p className="col-span-2">Vehicle Model</p>
            <p className="col-span-1">#23456</p>
            <p className="col-span-2">Vehicle Owner</p>
            <p className="col-span-1">Name</p>
            <p className="col-span-2">Owner Phone</p>
            <p className="col-span-1">8974561032</p>
            <p className="col-span-2">Vehicle Number</p>
            <p className="col-span-1">1234</p>
            <p className="col-span-2">RC Number</p>
            <p className="col-span-1">54678</p>
            <p className="col-span-2">Insurance</p>
            <p className="col-span-1">5467</p>
            <p className="col-span-2">Permit</p>
        ...
        <div className="col-span-9 grid grid-cols-12 p-6 space-y-4 dark:bg-darkgray bg-white   rounded-2xl">
          <div className="col-span-6">
            ...
            <div className="grid grid-cols-5 gap-2 font-light text-xs">
              ...
              <p className="col-span-1">20</p>
              <p className="col-span-3">Ratings</p>
        ...
        <div className="col-span-12 p-8 space-y-4 dark:bg-darkgray bg-white    rounded-2xl">
